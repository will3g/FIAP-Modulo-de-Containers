...
eval docker build -t myjupyterconfig -f ./configs/jupyter/Dockerfile ./configs/jupyter

eval docker tag mystreamlitconfig gcr.io/<project_id>/mystreamlitconfig:latest
eval docker tag myjupyterconfig gcr.io/<project_id>/myjupyterconfig:latest

eval docker push gcr.io/<project_id>/mystreamlitconfig:latest
eval docker push gcr.io/<project_id>/myjupyterconfig:latest
...
eval kubectl apply -f ./jupyter-deployment.yaml
eval kubectl apply -f ./jupyter-tcp-service.yaml
